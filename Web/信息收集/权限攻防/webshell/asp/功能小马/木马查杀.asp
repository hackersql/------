...
<title>KOA ASP类 WebShell(木马)扫描工具<%=VERSION%></title>
<style type="text/css">
...
<div>
	<form method="post" action="?act=login">
		请输入密码:<input name="pwd" type="password" size="15"><input type="submit" name="Submit" value="提交">
	</form>
</div>
<%
Else
...
%>
		<form action="?act=scan" method="post" name="form" id="scanForm">
			<table cellspacing="1" cellpadding="0" class="style1">
				...
				<tr>
					<td colspan="2" class="style2">版本号:<%=VERSION%> 版权所有:<a href="http://kingoa.net/">http://kingoa.net/</a> 欢迎传播推广，修改请保留版权。</td>
				</tr>
			</table>
		</form>
<%
