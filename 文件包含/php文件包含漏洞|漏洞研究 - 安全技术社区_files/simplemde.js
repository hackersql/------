...
},{"base64-js":3,"ieee754":2,"isarray":1}],6:[function(require,module,exports){
...
},{"buffer":5,"fs":4}],7:[function(require,module,exports){
...
function drawImage(editor) {
			B.require('app.insertImage', function(B){
				B.app.insertImage(B.$('.fa-eye'));
			});
}
...
var toolbarBuiltInButtons = {
	...
	"guide": {
		...
		className: "fa fa-question-circle fa-pull-right",
		title: "Markdown Guide",
		default: true
	},
	"backwind": {
		name: "backwind",
		action: "javascript:doBackWind();",
		className: "fa fa-window-restore fa-pull-right",
		title: "Back To WindEditor",
		default: true
	},
	"separator-4": {
		name: "separator-4"
...
function SimpleMDE(options) {
	...
	if(autoDownloadFA) {
		...
		link.rel = "stylesheet";
		link.href = "simplemde/dist/font-awesome.min.css";
...
SimpleMDE.prototype.drawImageURL = function(myurl) {
	var cm = simplemde.codemirror;
	var stat = getState(cm);
	var options = simplemde.options;
  console.log(myurl);
	_replaceSelection(cm, stat.image, options.insertTexts.image, myurl);
