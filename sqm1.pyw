...
class app(Frame):
    def __init__(self, mw):
        ...
        mw.bind('<Alt_L><s>',self.alt_key_s)
        mw.bind('<Alt_L><l>',self.alt_key_l)
        mw.bind('<Alt_L><e>',self.alt_key_e)
        mw.bind('<F2>',self.commands)
        mw.bind('<Shift_L><F2>',self.injectIT)
        ...
        genFileLF.grid(row=4, sticky='we',columnspan=9, rowspan=3)
        ...
        self.chkSesFile.grid(row=0,column=0,sticky = 'w')
        #
        self.eSesFile = ttk.Entry(genFileLF,width=20)
        self.eSesFile.grid(row=0,column=1, sticky='w',padx=10)
        ...
        self.chkTrafFile.grid(row=0,column=2,sticky = 'w',padx=10)
        #
        self.eTrafFile = ttk.Entry(genFileLF,width=20)
        self.eTrafFile.grid(row=0,column=3, sticky='w', padx=3)
        # TOR
    ...
    def commands(self,*args):
        ...
        try:
            inject = target+self.chekParam()+self.chek_tam()+ \
                ...
                self.fPrivEsc()+self.fTMPPATH()+self.chekFile()+ \
                ...
                self.chek_last()+self.chek_verb()+self.fSqlShell()+ \
